...
namespace DVLD
{
    public partial class PersonCardControl : UserControl
    {
        ...
        public clsPerson GetPerson()
        {
            ...
            _Person.Gender = rbMale.Checked ? clsPerson.GenderType.Male : clsPerson.GenderType.Female;
            ...
            _Person.CountryID =
                cbCountry.SelectedValue is int id ? id : -1;
        ...
        public void SetPerson(clsPerson person)
        {
            ...
            rbMale.Checked = _Person.Gender == clsPerson.GenderType.Male;
            rbFemale.Checked = _Person.Gender == clsPerson.GenderType.Female;
        ...
        {
            List<clsCountry> countries = await clsCountry.GetAllAsync();
            if (countries == null)
                return;
        ...
        private async void txtNationalNo_Validating_1(object sender, CancelEventArgs e)
        {
            ...
            bool exists =
                await clsPerson.ExistsNationalIDAsync(
